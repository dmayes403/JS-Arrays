...
// console.dir(devMountainEmployees.length);
//
//
// //NEXT PROBLEM
//
...
function finder(arr){
  rando = getRandomArbitrary();
  for(var i =0;i<arr.length;i++){
    if(arr[i] === rando){
      return true;
    } else if (i === arr.length-1 && arr[i] !== rando){
      return false;
    }
  }
  return false;
